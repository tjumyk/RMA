...
def main(data_source, data_type, iteration, model_suffix='', feature_suffix='', save_format='default', top_k=3):
    ...
    d_ctx_raw = get_feature_results('basic_fea_ctx_local_top5_recomputed', data_type, data_source)
    d_ctx = fetch_all_features('basic_fea_ctx_local_top5_recomputed', data_type, data_source)
    d_coref = fetch_all_features('basic_fea_coref_local_top5', data_type, data_source)
    ...
    if iteration == 0:
        model_name = '4900_6_ctx_coref_local_top5_recomputed'  # local model
        coh_feature_name = None
    elif iteration == 1:
        model_name = '4900_6_ctx_coref_coh_local_top5_recomputed%s' % model_suffix  # initial global model
        coh_feature_name = 'basic_fea_coh_local_top5_recomputed%s' % feature_suffix
    elif iteration == 2:
