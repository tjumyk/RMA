...
def main(data_source, data_type, iteration, model_suffix='', feature_suffix='', save_format='default', top_k=3):
    ...
    d_ctx_raw = get_feature_results('basic_fea_ctx_global_top5', data_type, data_source)
    d_ctx = fetch_all_features('basic_fea_ctx_global_top5', data_type, data_source)
    d_coref = fetch_all_features('basic_fea_coref_global_top5', data_type, data_source)
    ...
    if iteration == 0:
        model_name = '4900_6_ctx_coref_global_top5'  # local model
